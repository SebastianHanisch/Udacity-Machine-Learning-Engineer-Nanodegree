...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = tuple([waypoint, inputs['light'], inputs['left']])#, inputs['oncoming'], inputs['right']
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            ...
            if prob < self.epsilon:
                ...
                action_list = [act for act, val in self.Q[state].items() if val == self.get_maxQ(state)]
